...
def create_baseline(clf_name,dataset_orig, privileged_groups,unprivileged_groups,
    ...
    """ Create a baseline by mutating predictions of an original classification model_1 (clf_name).
        ...
        for degree in degrees:
            ...
            for name,o in odds.items():
                ...
                for _ in range(repetitions):
                    ...
                    # Determine accuray and fairness of mutated model_1
                    ...
                    hist.append([class_metric.accuracy(),stat,aod])
